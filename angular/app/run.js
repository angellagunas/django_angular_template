(function() {
  angular.module('angular_template').run(["$log", "$localStorage", "$state", "$stateParams", "$rootScope", "$location", "$content", function($log, $localStorage, $state, $stateParams, $rootScope, $location, $content) {
    'ngInject';
